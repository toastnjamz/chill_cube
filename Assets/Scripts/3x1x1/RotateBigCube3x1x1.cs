...
public class RotateBigCube3x1x1 : MonoBehaviour
{
    ...
    {
        // returns true if the swipe was in the x direction and didn't move much in the y direction
        return currentSwipe.x < 0 && currentSwipe.y > -0.5f && currentSwipe.y < 0.5f;
    }

    bool RightSwipe(Vector2 swipe)
    {
        // returns true if the swipe was in the y direction and didn't move much in the x direction
        return currentSwipe.x > 0 && currentSwipe.y > -0.5f && currentSwipe.y < 0.5f;
    }
